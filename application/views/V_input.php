                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card-box">
                            ...
                            <h4 class="header-title m-t-0">Masukkan Data</h4>


                            <div class="p-20 m-b-20">
                                <form action="<?php echo site_url('input/tambah_aksi');?>" class="form-validation" method="post">
                                    <div class="form-group">
                                        <label for="userName">Nama <span class="text-danger">*</span></label>
                                        <input type="text" name="nama" parsley-trigger="change" required
                                               placeholder="" class="form-control" id="nama">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alamat" parsley-trigger="change" required
                                               placeholder="" class="form-control" id="alamat">
                                    </div>
                                    <div class="form-group">
                                        <label for="nrp">Nrp<span class="text-danger">*</span></label>
                                        <input id="nrp" type="text" placeholder="" required name="nrp"
                                               class="form-control">
                                    </div>
